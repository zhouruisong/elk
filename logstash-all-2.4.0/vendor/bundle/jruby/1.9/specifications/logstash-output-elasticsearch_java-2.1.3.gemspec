# -*- encoding: utf-8 -*-
# stub: logstash-output-elasticsearch_java 2.1.3 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<logstash-output-elasticsearch>, [">= 2.1.4"])
      ...
      s.add_dependency(%q<logstash-output-elasticsearch>, [">= 2.1.4"])
